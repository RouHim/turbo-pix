...
- **FR-015**: The i18n system MUST support English (en) and German (de) locales with all current translation keys preserved. Locale MUST be persisted to localStorage and default to the backend `/api/config` value, falling back to `en`.
